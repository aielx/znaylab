...
export const site = {
  ...
  legal: {
    ...
    // Лицензия на образовательную деятельность. Дата — «дата предоставления лицензии»
    // (термин нового бланка лицензии, не «дата выдачи»).
    license: '№ Л035-01298-77/06898447',
    licenseDate: '16.09.2026',
    licenseIssuer: 'Департамент образования и науки города Москвы',
    licenseSubtype: 'Дополнительное образование детей и взрослых',
    licenseOrder: 'Приказ от 16.09.2026 № ПР/УГНК-2090/26',
    // Выписка из реестра лицензий (PDF) — хранится в public/documents/.
    licenseDoc: '/documents/licenziya-L035-01298-77-06898447.pdf',
    licenseDocName: 'Выписка из реестра лицензий № Л035-01298-77-06898447.pdf',
    ...
    checkingAccount: '40802810102080004968', // расчётный счёт (20 цифр)
    bankName: 'АО «АЛЬФА-БАНК»',
    bik: '044525593', // БИК банка (9 цифр)
    corrAccount: '30101810200000000593', // корреспондентский счёт (20 цифр)
  },

  // Наименование банка-эквайера для текстов оферты и страницы оплаты.
  // Пустая строка — нейтральная формулировка «платёжный провайдер».
  paymentProvider: 'АО «АЛЬФА-БАНК»',
